...
public class HTMLReportGenerator {
	...
	public static void StepDetails(Object object,String StepName,String StepDetails)
	{
		String stepinfo=null;
			...
			else
			{
				...
				if(((String) object).equalsIgnoreCase("pass"))
				{		testcaseobj.log(LogStatus.PASS,StepName,stepinfo);}
				else if(((String) object).equalsIgnoreCase("fail"))
				{		testcaseobj.log(LogStatus.FAIL,StepName, stepinfo);}
				else if(((String) object).equalsIgnoreCase("error"))
				{		testcaseobj.log(LogStatus.ERROR,StepName, stepinfo);}
				else if(((String) object).equalsIgnoreCase("info"))
